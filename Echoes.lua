...
function Echoes:NormalizeAndClampMainWindowToScreen()
    ...
    -- First normalize to a TOPLEFT anchor so tab size changes don't shift the top bar.
    ...
    -- Then clamp to screen bounds (in UIParent coordinate space).
    ...
    -- Keep a small margin so the title bar remains reachable.
    local margin = 20

    -- If the frame is larger than the screen, just center it.
